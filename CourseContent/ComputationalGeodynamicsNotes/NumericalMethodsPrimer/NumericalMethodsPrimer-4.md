...
*What curve gives the shortest distance between two points in a plane ?  And how can we prove it !*
...
*A Slab of Material Subjected to an sudden onset of heating at $Q$ on one side at time $t=0$*
